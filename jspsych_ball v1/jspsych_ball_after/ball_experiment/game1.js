...
const intro1 = {
    ...
    stimulus: `
        <div style="text-align: left; margin: 50px 150px;">
            ...
            <p>每局游戏里，你需要根据所有展示出的球<b>推测</b>本局被挑中的<b>是哪个箱子</b>。</p>
        </div>
    `,
    choices: ["下一页"]
};
    ...
    stimulus: `
        <div style="text-align: left; margin: 100px 100px;">
            ...
            <div style="display:flex;align-items:center">
                <div style="flex:4">
                    <p>在两个游戏中，<span style="font-weight: bold;color: rgb(142,27,17);">每100积分等同于1元的额外报酬</span>，我们将在实验结束后另行追付。本游戏你拥有 <strong>${gameState.totalEarnings}</strong> 起始积分，游戏共进行 <strong>${gameState.numRounds}</strong> 局，你在游戏 1 中的总积分为${gameState.numRounds}局游戏的累积积分。<b>每局游戏具体规则如下：</b></p>
                    ...
                    <p> 
                        (4) 每局结束后，如果<span style="font-weight: bold;color: rgb(142,27,17);">判断正确</span>，将<span style="font-weight: bold;color: rgb(142,27,17);">获得 50 积分</span>；如果<span style="font-weight: bold;color: rgb(142,27,17);">判断错误</span>，将<span style="font-weight: bold;color: rgb(142,27,17);">失去 50 积分</span>。你的收益只取决于判断是否正确，而与做出判断的轮次无关。
                    </p> 
                </div>
                <!-- img -->
