        ...
        <div class="radio-option">
            ...
            <div class="option-group">
                ...
                <label>
                    ...
                    <span style="width:95%">如果三个工作日后收盘时，美国强生与默沙东两家公司的市值差额<span style="font-weight: bold;color: rgb(142,27,17);">低于</span>1665亿美元，你将获得100元；否则获得0元。</span>
                </label>
            </div>
        </div>
        <br>
        ...
        <div class="radio-option">
            ...
            <div class="option-group">
                ...
                <label>
                    ...
                    <span style="width:95%">如果三个工作日后收盘时，美国强生与默沙东两家公司的市值差额<span style="font-weight: bold;color: rgb(142,27,17);">高于或等于</span>1665亿美元，你将获得100元；否则获得0元。</span>
                </label>
            </div>
        </div>
        <br>
