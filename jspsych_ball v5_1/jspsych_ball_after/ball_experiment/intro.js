let intro_text = `
    ...
    <div class="centered-list">
        <ul>
            ...
            <li>这项实验由北京大学和北京师范大学的研究人员：梅文俊教授、张博宇教授、冯毅隆博士和王晓敏博士进行。如果您对本实验有任何疑问，或难以访问网站或完成实验，请联系: pkucoe_meilab@163.com 。</li>
    ...
    <div style="text-align: left; margin-left: 20px;">
        <input type="checkbox" id="consentCheckbox2" onclick="toggleButton()"> 请不要按浏览器上的后退按钮或刷新按钮！这将导致实验数据丢失，影响您获得报酬。
    </div>
    <div style="text-align: left; margin-left: 20px;">
