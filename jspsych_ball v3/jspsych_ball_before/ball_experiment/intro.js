let intro_text = `
    ...
    <div class="centered-list">
        <ul>
            <li>本实验由三个问卷和<span style="font-weight: bold;color: rgb(142,27,17);">两个决策游戏</span>组成。你将获得<span style="font-weight: bold;color: rgb(142,27,17);">15元基础报酬</span>，并根据你在<span style="font-weight: bold;color: rgb(142,27,17);">两个游戏</span>中的实际表现获得<span style="font-weight: bold;color: rgb(142,27,17);">至多15元的额外报酬</span>。 </li>
