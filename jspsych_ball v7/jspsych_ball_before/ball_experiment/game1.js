...
const videoIntro = {
    ...
    stimulus: ['img/game1_intro.mp4'],
    prompt: '<div style="position: absolute; top: 20px; left: 50%; transform: translateX(-50%); z-index: 1000;"><h2 style="text-align: center; margin: 0; background-color: rgba(255,255,255,0.9); padding: 10px; border-radius: 5px;">游戏1介绍视频</h2></div>',
    width: 800,
    height: 600,
    autoplay: true,
    controls: true,
